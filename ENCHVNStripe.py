...
dollar=50
GROUP_ID = ['#']
token = '6904770945:AAHPsftVVSoBdsNl25CaLi2-AQsZTRs7YRo'
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber = 5843737942
	...
	try:
		with open("combo.txt", 'r') as file:
			...
			for cc in lino:
				...
				bot.edit_message_text(chat_id=message.chat.id, message_id=ko, text='''Eyad CHK Is Luanching ➜ @A_6_X_0''', reply_markup=mes)
